...
-- 2) Ulaşım Verileri
INSERT INTO Ulaşım (UlaşımID, AraçTipi, Saatler, Ücret, HavalimanıID) VALUES
(1, 'Taksi', '24 Saat', 150.00, 1),
(2, 'Otobüs', '06:00-23:00', 50.00, 1),
(3, 'Metro', '06:00-00:00', 20.00, 1),
(4, 'Taksi', '24 Saat', 200.00, 2),
(5, 'Otobüs', '05:30-23:30', 60.00, 2),
(6, 'Havalimanı Servisi', '04:00-22:00', 30.00, 3),
(7, 'Taksi', '24 Saat', 180.00, 4),
(8, 'Otobüs', '07:00-22:00', 45.00, 4),
(9, 'Metro', '06:30-23:30', 25.00, 5),
(10, 'Havalimanı Servisi', '05:00-21:00', 40.00, 5);

-- 3) Havayolu Şirketi Verileri
...
-- Sequence (Sayaç) Güncellemeleri
SELECT setval(pg_get_serial_sequence('Havalimanı', 'havalimanıid'), 10);
SELECT setval(pg_get_serial_sequence('Ulaşım', 'ulaşımıd'), 10);
